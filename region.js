(function () {
  ...
  const textTranslations = {
    zh: {
      ...
      "at IPI Centre Sydney. Confirm your attendance by 27 June.": "地点为 IPI 悉尼中心。请在 6 月 27 日前确认出席。",
      "Confirm now": "立即确认",
      "Today's Goals": "今日目标",
      "Edit": "编辑",
      ...
      "Action required": "需要处理",
      "Confirm attendance and upload supporting documents by 27 June 2026.": "请在 2026 年 6 月 27 日前确认出席并上传支持文件。",
      "All files must be submitted by 27 June 2026, 10:00 AM Sydney time.": "所有文件须在 2026 年 6 月 27 日上午 10:00（悉尼时间）前提交。",
      ...
      "Not yet opened": "尚未开放",
      "Before the test": "考试前",
      "Confirm attendance by 27 June": "6 月 27 日前确认出席",
